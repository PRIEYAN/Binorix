          ...
          <div className="flex flex-col gap-6">
            <div className="grid gap-2">
              ...
              <Input
                ...
                required
              />
              <Label htmlFor="registrationNumber" className="pt-2 pb-2">Enter your Hospital Reg Number</Label>
              <Input
                ...
                required
              />
              <Label htmlFor="establishmentYear" className="pt-2 pb-2">Hospital Establishment Year</Label>
              <Input
              ...
              <Input
                ...
                onChange={handleInputChange}
              />
              <Label htmlFor="location" className="pt-2 pb-2">Enter your Hospital Location</Label>
              <Input
                id="location"
                type="text"
